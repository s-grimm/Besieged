...
{
    public class AshPassable : DrawableObject, ITile
    {
    ...
    public class AshImpassable : DrawableObject, ITile
    {
    ...
    public class MagmaPassable : DrawableObject, ITile
    {
    ...
    public class MagmaImpassable : DrawableObject, ITile
    {
