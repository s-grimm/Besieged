...
{
    public class MudPassable : DrawableObject, ITile
    {
    ...
    public class MudImpassable : DrawableObject, ITile
    {
    ...
    public class SwampPassable : DrawableObject, ITile
    {
    ...
    public class SwampImpassable : DrawableObject, ITile
    {
