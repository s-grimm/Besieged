...
namespace BesiegedServer
{
    internal class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            try
            {
                svcHost = new ServiceHost(typeof(BesiegedServer), new Uri("net.tcp://192.168.1.115:31337/BesiegedServer/"));
                ...
                EndpointAddress endpointAddress = new EndpointAddress("net.tcp://192.168.1.115:31337/BesiegedServer/BesiegedMessage");
